                    ...
                    }
                    {
                      ...
                      <div className="space-y-4">
                            ...
                            <div>
                                  <Link href="/enter">
                                        <a>
                                              <div className="fill-gray-100 text-gray-100 hover:bg-gray-100 hover:fill-gray-900 hover:text-gray-900 hover:shadow-lg shadow-xl flex flex-row space-x-1 bg-gray-900 p-2 items-center justify-center rounded">
                                                    ...
                                                    <div><svg className="fill-inherit " width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M9 20h-3v3h-4v-8.766l5.698-4.921 1.711 1.384 6.591-5.697 6 5.236v12.764h-5v-4h-3v4h-5v-3zm-2-5h-2v2h2v-2zm3 0h-2v2h2v-2zm5-1h-2v2h2v-2zm3 0h-2v2h2v-2zm-8.642-7.253l6.642-5.747 8 7-1.329 1.495-6.671-5.819-6.624 5.738-1.678-1.414-6.369 5.495-1.329-1.495 7.698-6.676 1.66 1.423zm5.642 4.253h-2v2h2v-2zm3 0h-2v2h2v-2z"/></svg></div>
